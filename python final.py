...
inp_window.title("SCOREBOARD")
game_window.configure(bg='crimson')
inp_window.configure(bg='orange')
...
input_frame.pack()
inp_frame = Frame(inp_window)
inp_frame.pack()

#Displaying player options
player_options = Label(input_frame, text = "Your Options : ", font = app_font, fg = 'RED')
player_options.grid(row = 0, column = 0, pady = 8)
rock_btn = Button(input_frame, text = 'Rock', width = 15, bd = 0, bg = 'lime', pady = 5, command = lambda: player_choice(options[0]))
rock_btn.grid(row = 1, column = 1, padx = 8, pady = 5)
paper_btn = Button(input_frame, text = 'Paper', width = 15, bd = 0, bg = 'PURPLE', pady = 5, command = lambda: player_choice(options[1]))
paper_btn.grid(row = 1, column = 2, padx = 8, pady = 5)
scissors_btn = Button(input_frame, text = 'Scissors', width = 15, bd = 0, bg = 'yellow', pady = 5, command = lambda: player_choice(options[2]))
...
player_score_label = Label(inp_frame, text = 'Your Score : -', font = app_font)
...
computer_score_label = Label(inp_frame, text = 'Computer Score : -', font = app_font, fg = 'black')
computer_score_label.grid(row = 4, column = 2, padx = (10,0), pady = 5)

game_window.geometry('700x300')
inp_window.geometry('280x200')
